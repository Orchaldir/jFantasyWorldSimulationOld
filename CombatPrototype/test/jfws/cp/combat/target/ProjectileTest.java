...
public class ProjectileTest
{
	...
	{
		assertTrue(projectile_.canTargetUser(character0_, inside_));
	}
	
	@Test
	public void testCanTargetCharacterWithUser()
	{
		assertTrue(projectile_.canTargetCharacter(character0_, character0_, inside_));
	}
	
	@Test
	public void testCanTargetCharacter()
	{
		assertTrue(projectile_.canTargetCharacter(character0_, character1_, inside_));
	}
	
	@Test
	public void testCanTargetCharacterTooFar()
	{
		assertFalse(projectile_.canTargetCharacter(character0_, character1_, outside_));
	}
	
	@Test
	public void testCanTargetPosition()
	{
		assertTrue(projectile_.canTargetPosition(character0_, pose_, inside_));
	}
	
	@Test
	public void testCanTargetPositionTooFar()
	{
		assertFalse(projectile_.canTargetPosition(character0_, pose_, outside_));
	}
	...
	{
		List<Character> targets = projectile_.targetCharacter(character0_, character1_, inside_);
	...
	{
		List<Character> targets = projectile_.targetCharacter(character0_, character1_, outside_);
	...
	public void testTargetPosition()
	{
		...
		List<Character> targets = projectile_.targetPosition(character0_, pose_, inside_);
	...
	public void testTargetPositionTooFar()
	{
		...
		List<Character> targets = projectile_.targetPosition(character0_, pose_, outside_);
